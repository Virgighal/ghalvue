                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false">
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == picture ? 'active' :''">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == picture ? 'active' :''">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == picture ? 'active' :''">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] == picture ? 'active' :''">
...
import HeaderGhal from '@/components/HeaderGhal.vue'
import RelatedProduct from '@/components/RelatedProduct.vue'
import FooterGhal from '@/components/FooterGhal.vue'
